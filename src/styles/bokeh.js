...
(function () {
  ...
  registerStyle({
    ...
    defaults: {
      ...
      bokehCool: "#6d7882",
      bokehBgTop: "#05070a",
      bokehBgBottom: "#0d1318",
      bokehPreset: "graphene-default"
    },
    colorIds: ["bokehWarm", "bokehAccent", "bokehCool", "bokehBgTop", "bokehBgBottom"],
    presets: projectPalettes((p) => ({ bokehWarm: p.accent, bokehAccent: p.accent2, bokehCool: p.lineColor, bokehBgTop: p.backgroundTop, bokehBgBottom: p.backgroundBottom })),
    inputIds: [
      "bokehDiscCount",
      "bokehSizeMin",
      "bokehSizeMax",
